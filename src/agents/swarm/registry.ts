...
export const specialistRegistry: Record<string, SwarmAgentConfig> = {
  ...
  cto: {
    ...
    composioToolkits: ['github', 'aws', 'vercel'],
  },
  cmo: {
    name: 'CMO',
    department: 'Growth',
    ...
    tools: { ...fileSystemTools, ...webIntelligenceTools, ...skillTools },
    composioToolkits: ['google_ads', 'hubspot', 'mailchimp'],
  },
  cro: {
    name: 'CRO',
    department: 'Revenue',
    ...
    composioToolkits: ['stripe', 'hubspot', 'salesforce'],
  },
  headOfOperations: {
    ...
    tools: { ...fileSystemTools, ...webIntelligenceTools, ...skillTools },
    composioToolkits: ['quickbooks', 'zendesk', 'docusign'],
  },
  ciso: {
    name: 'CISO',
    department: 'Security',
    ...
    tools: { ...fileSystemTools, ...shellTools, ...skillTools },
    composioToolkits: ['aws_securityhub', 'github'],
  },
  cdo: {
    name: 'CDO',
    department: 'Data',
    ...
    tools: { ...fileSystemTools, ...shellTools, ...skillTools },
    composioToolkits: ['snowflake', 'bigquery', 'langsmith'],
  },
